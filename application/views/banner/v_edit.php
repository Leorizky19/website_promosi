<div class="col-md-12">
    ...
    <div class="card-body">
        ...
        echo form_open_multipart('banner/edit/' . $banner->id_banner) ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
            <div class="form-group">
                <img src="<?= base_url('upload/banner/'. $banner->image)?>" id="image_load" width="200px" alt="">
            </div>
            </div>
            </div>
            <div class="form-group">
