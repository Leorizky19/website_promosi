           ...
           <div class="card-body">
            ...
            if ($this->session->flashdata('pesan')) {
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $no = 1; 
                    foreach ($header_pricing as $key => $value){?>
                    <tr>
...
<div class="modal fade" id="add">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <?php
            echo form_open('header_pricing/add');
            ?>
...
<div class="modal fade" id="edit<?= $value->id_header ?>">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <?php
            echo form_open('header_pricing/edit/' . $value->id_header);
            ?>
...
<div class="modal fade" id="delete<?= $value->id_header ?>">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
              <a href="<?= base_url('header_pricing/delete/' . $value->id_header);?>" type="submit" class="btn btn-outline-light">Delete</a>
            </div>
            <?php
            echo form_close('');
            ?>
