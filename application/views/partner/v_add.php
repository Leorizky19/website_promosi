<div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Form Add Partner</h3>
        </div>
    <!-- card header -->
    <div class="card-body">
        <?php 
        ...
        echo form_open_multipart('partner/add')?>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_partner" class="form-control" rows="5" placeholder="Text" 
                    value="<?= set_value('nama_partner');?>">
                </div>
                <div class="row">
                    <div class="col-sm-6">
            <div class="form-group">
