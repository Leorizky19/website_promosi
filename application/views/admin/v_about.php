                  ...
                  <?php $no = 1; 
                    ...
                    <tr>
                        ...
                        <td><?= $value->texts?></td>
                            ...
                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?= $value->id_about ?>"
                            ><i class="fas fa-edit"></i></button>
                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete<?= $value->id_about ?>"
...
<div class="modal fade" id="add">
      ...
      <!-- /.modal -->
       ...
       foreach ($about as $key => $value){
         ?>
<div class="modal fade" id="edit<?= $value->id_about ?>">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            <div class="modal-header">
              <h4 class="modal-title">Edit Tentang Aplikasi</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <?php
            echo form_open('about/edit/' . $value->id_about);
            ?>
      ...
      <?php }?>
       ...
       foreach ($about as $key => $value){
         ?>
<div class="modal fade" id="delete<?= $value->id_about ?>">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            <div class="modal-header">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
              <a href="<?= base_url('about/delete/' . $value->id_about);?>" type="submit" class="btn btn-outline-light">Delete</a>
            </div>
            <?php
            echo form_close('');
            ?>
