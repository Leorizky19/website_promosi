...
<div class="modal fade" id="add">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <?php
            echo form_open('content_about/add');
            ?>
...
<div class="modal fade" id="edit<?= $value->id_content ?>">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <?php
            echo form_open('content_about/edit/' . $value->id_content);
            ?>
...
<div class="modal fade" id="delete<?= $value->id_content ?>">
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
              <a href="<?= base_url('content_about/delete/' . $value->id_content);?>" type="submit" class="btn btn-outline-light">Delete</a>
            </div>
            <?php
            echo form_close('');
            ?>
